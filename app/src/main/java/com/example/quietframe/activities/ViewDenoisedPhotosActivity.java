...
public class ViewDenoisedPhotosActivity extends AppCompatActivity {
    ...
    private void changeTextColor(TextView textView, String fullText, String differentColorText){
        ...
        spannableString.setSpan(new ForegroundColorSpan(ContextCompat.getColor(this, R.color.color_primary_dark)), startIndex, endIndex, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
